...
<!-- wrap start -->
<div id="wrap">
	<div class="main_left"><img src="/img/main/main_left.png" alt=""></div>
<?
include_once('header.php');
?>
	<div class="lnb_wrap t_center">
		<div class="nav_logo"><a href="<?=$root?>/"><img src="<?=$root?>/img/main/nav_bi.png" alt="상무"></a></div>
...
?>
			<li<?if(in_array($gnb_index, $on_index) && $depth2_list['view3_order_css'] == $minor_index){echo ' class="on"';}?>>
				<a href="<?=$depth2_link?>">
