...
(function($) {
	$(document).ready(function() {
		...
		(new TimelineMax({repeat: -1, delay: 4.0, repeatDelay: 4.0, yoyo: true}))
		.add([
			TweenLite.to('.btn-opener .front', 0.5, {backfaceVisibility: 'hidden', rotationY: 180}),
			TweenLite.to('.btn-opener .back', 0.5, {backfaceVisibility: 'hidden', rotationY: 0})
		]);
