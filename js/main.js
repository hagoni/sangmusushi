...
(function($) {
    doc.ready(function(){
		...
		(function() {
            ...
            var $topElement = $('.nav_wrap_sm'),
                offset = $('.nav_wrap_sm').offset().top,
                fixed = false;
        ...
        var $swiperItems = $('.lyr3_slide .swiper-slide'),
            $progress,
            custPging = $('.lyr3_paging li');
            interval = 5000;

        var lyr3Slide = new Swiper('.lyr3_slide .swiper-container', {
            setWrapperSize: true,
            speed: 500,
                autoplay: {
                delay: 5000,
            ...
            on: {
                slideChangeTransitionEnd: function() {
                    $progress = $('.lyr3_paging').find('.progress-bar');
                    var prevI = lyr3Slide.previousIndex, i = lyr3Slide.activeIndex;
        ...
        new Swiper('.menu_slide .swiper-container', {
            ...
            navigation: {
                nextEl: '.menu_btns.menu_next',
                prevEl: '.menu_btns.menu_prev',
            },
            effect: 'fade',
            fadeEffect: {
            	crossFade: true
