(function($) {
    ...
    window.RecruitModal = function(options) {
        ...
        var body = $('body'),
            containerId = '#recruitModalContainer',
            containerH,
            container,
            contentId = '#recruitContent',
            anchor = '.bindRecruitModalOpen',
            xBtnId = '#recruitModalX',
            spinId = '#recruitSpinner',
            modalHtml = '',
            modalPosition,
            modalTop,
            blockBg,
        ...
        this.setModalHtml = function() {
            modalHtml += '<div id="recruitModalContainer" style="display:none">\n';
            modalHtml += '  <div class="recruit_modal_wrap">\n';
            modalHtml += '      <div id="recruitContent">\n';
            modalHtml += '      </div>\n';
            modalHtml += '      <div id="recruitSpinner"><img src="'+ opt.modalImgPath +'/spinner01.gif" alt="" /></div>\n';
            modalHtml += '  </div>\n';
            modalHtml += '  <button type="button" id="recruitModalPrev" class="recruit_modal_btns"><img src="'+ opt.modalImgPath +'/modal_prev.png" alt="이전"></button>\n';
            modalHtml += '  <button type="button" id="recruitModalNext" class="recruit_modal_btns"><img src="'+ opt.modalImgPath +'/modal_next.png" alt="다음"></button>\n';
            modalHtml += '  <button type="button" id="recruitModalX"><img src="'+ opt.modalImgPath +'/modal_x.png" alt="닫기"></button>\n';
            modalHtml += '</div>';
        };
        ...
        this.modalOpen = function(e) {
            if(changing === false) {
                ...
                if(typeof body.attr('style') !== 'undefined'){
                    body.attr('data-style',body.attr('style'));
                }
        ...
        this.iframe = function(el) {
            ...
            var iframeHtml = '<iframe id="iframeContent" width="100%" height="100%" frameborder="0" scrolling="yes"></iframe>',
                ...
                nextBtnId = '#recruitModalNext',
                prevBtnId = '#recruitModalPrev',
                prevIndex = -1,
        ...
        this.modal = function(el) {
            var requestUrl = el.data('type') === 'facebook' ? CONST_ROOT + '/board/index.php?board=recruit&sca=blog&tab=2&fbContainerId='+ encodeURIComponent('#') + 'recruitContent' : CONST_ROOT + '/board/index.php?board=recruit&sca=blog&tab=3&igContainerId='+ encodeURIComponent('#') + 'recruitContent';
        ...
        this.modalX = function() {
            ...
            if(typeof body.attr('data-style') !== 'undefined'){
