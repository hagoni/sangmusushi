...
?>
    <div class="lnb_wrap swiper-container">
        <ul class="lnb swiper-wrapper">
<?
$depth2_link_query = "SELECT * FROM `".TABLE_LEFT."board` WHERE view3_use_m = '1' AND view3_setup = '$html_idx' AND view3_group_idx = '".$group_list['view3_idx']."' ORDER BY view3_order";
$depth2_result = mysql_query($depth2_link_query);
$depth2_i = 1;
$on_index = array('4');
while($depth2_list = mysql_fetch_assoc($depth2_result)) {
...
?>
			<li class="<?if(in_array($gnb_index, $on_index) && $depth2_list['view3_order_css'] == $minor_index){echo 'on';}?> swiper-slide">
				<a href="<?=$depth2_link?>">
					<?=strip_tags(html_entity_decode($depth2_list['view3_title_01']))?>
				</a>
			</li>
<?
	$depth2_i++;
