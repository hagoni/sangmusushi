...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?autoload=false&libraries=services&appkey=<?=$settings_data['kakao_api_m_key'];?>"></script>
            ...
            if (navigator.geolocation) {
                ...
                navigator.geolocation.getCurrentPosition(function(position) {
                    ...
                    $.post('<?=$root?>/resource/map_01.php',{idx:mapIndex},function(res){
                        ...
                        $(document).find('.geo_con').html(data['title'] + ' 이 귀하와 가장 가까운 곳에<br>위치하고 있습니다.');
                        $(document).find('.geo_tlt').attr('data-idx',mapIndex);
                    });
