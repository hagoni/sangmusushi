...
<?
} else if(strtolower($list['view3_video']) == 'kakaotv') {
?>
			<iframe width="100%" height="100%" src="https://play-tv.kakao.com/embed/player/cliplink/<?=$list['view3_link']?>?service=daum_searchview" allowfullscreen frameborder="0" scrolling="no" allow="autoplay"></iframe>
<?
} else {
?>
