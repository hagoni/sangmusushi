...
$sql = "SELECT * FROM `view3_map_01` WHERE view3_use='1' AND (view3_addr_road REGEXP '{$_REQUEST[search]}' OR view3_addr_number REGEXP '{$_REQUEST[search]}')".' AND `view3_addr_x`!="" AND `view3_addr_y`!="" '.$view_order.';';
